...
exampleBar.add_command(label="Example 1", command=lambda: print("Example 1"))
exampleBar.add_command(label="Example 2", command=lambda: print("Example 2"))
exampleBar.add_command(label="Example 3", command=lambda: print("Example 3"))
